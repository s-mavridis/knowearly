  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 pt-32 pb-24 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Abstract shapes */}
        <div className="absolute top-20 right-10 w-96 h-96 bg-emerald/5 rounded-full blur-3xl animate-float" />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-emerald/3 to-primary/3 rounded-full blur-3xl" />
