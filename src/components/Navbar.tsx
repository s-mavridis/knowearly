...
const Navbar = () => {
  return <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-3rem)] max-w-6xl">
      <div className="flex items-center justify-between px-6 py-3 rounded-full bg-earth/60 backdrop-blur-md border border-white/10">
        {/* Logo */}
        <Link to="/" className="flex items-center gap-2">
          ...
          <span className="text-lg font-semibold text-white">artemis</span>
        </Link>
