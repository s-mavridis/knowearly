    ...
    <footer className="py-20 px-6 border-t border-border/50">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          {/* HIPAA Badge */}
          <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full border border-electric-blue/20 bg-electric-blue/5">
            <Shield className="w-3.5 h-3.5 text-electric-blue" />
            <span className="text-xs font-medium text-electric-blue">HIPAA Compliant</span>
          </div>
        </div>
